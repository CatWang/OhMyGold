...
<div class="menu">
    ...
    <div align="center" class="bbb"><a href="account.jsp"><div class="active2">我的账户</div></a></div>
	...
	<div class="register1">
		<div class="form-horizontal"> 
	      <div class="form-group">
    	   <label for="addressFull" class="col-sm-2 control-label">账户余额</label>
    	   <label for="addressFull" class="col-sm-1 control-label">12233</label>
        </div>
          </div>
