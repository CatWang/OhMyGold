...
<div align="center"><button class="btn btn-primary" style="width:100px;height:35px;"  data-toggle="modal" data-target="#mymodal-data"  type="button">查看合同</button></div><!--跳出合同-->		
</div>
</div>
</form>
    ...
    <div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">gsdfgs<span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
