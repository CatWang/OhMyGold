...
<li><a href="self_info.jsp">xxx</a></li>
</ul>
</div>
</div>
</div>
...
<!--/nav-->   
	<div class="register" >
    <div align="center" style="font-family:'微软雅黑'"><h1>操作成功！</h1></div>
    <div style="font-family:'微软雅黑'"><h4>5秒后跳转到其他页面</h4></div>
    <%
    response.setHeader("refresh","5;URL=order_info.jsp"); 
    %>
</div>
    
		
</div>
<div class="root" style="margin:200px 0 0 0">
<ul>
