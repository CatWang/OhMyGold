...
<table class="table" style="width:500px;text-align:center;margin:20px 100px">
  ...
  <br />
  <div align="center"> <button class="btn btn-primary"type="submit"><a style="text-decoration:none;color:#fff" href="assignment_contract.jsp">购&nbsp;&nbsp;买</a></button><!--点击后直接跳转derivative_purchase.jsp-->
  <button class="btn btn-primary"type="submit"><a style="text-decoration:none;color:#fff" href="assignment_contract.jsp">出&nbsp;&nbsp;售</a></button><!--点击后直接跳derivative_purchase.jsp-->
