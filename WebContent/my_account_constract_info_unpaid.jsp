...
<table class="table" style="width:500px;text-align:center;margin:20px 100px">
  ...
  <tr>
    ...
    <td>
     <%=contact.getProvince()+"省"+contact.getCity()+"市" %> 
    </td>
  </tr>
  <tr>
    <th>生效月份：</th>
  ...
  <br />
  <div align="center"> <button class="btn btn-primary"type="submit"><a style="text-decoration:none;color:#FFF" href="assignment_contract.jsp">转&nbsp;&nbsp;让</a></button><!--点击后直接跳转assignment_contract_verify.jsp-->
   <button class="btn btn-primary" type="submit">结&nbsp;&nbsp;算</button></div><!--点击跳弹窗自动支付-->
   <!--这两个按钮有判定条件 如果过了生效月份只能按支付 如果没过生效月份 只能按转让 如果正在生效月份两个都不能按-->
   </div>
</div>
</form>
