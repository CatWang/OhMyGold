...
<%@page import="weath.function.GetContact"%>
...
<body style="background:rgb(244,245,250)">
	...
	<div class="register">
		<div class="return">
			<a href="assignment_contract.jsp">返回</a>
		</div>
		<%
			{
				String contactID = request.getParameter("contactID");
				GetContact cc = new GetContact();
				Contact contact = cc.getContact(contactID);
		%>

		<table class="table"
			style="width: 500px; text-align: center; margin: 20px 100px">
			<tr>
				<th class="col-sm-4">合同&nbsp;&nbsp;ID&nbsp;&nbsp;:</th>
				<td><%=contact.getContactID()%></td>
			</tr>

			<tr>
				<th class="col-sm-4">签约方&nbsp;&nbsp;&nbsp;：</th>
				<td><%=contact.getPartener2ID()%><!-- 这里有问题！！！ --></td>
			</tr>
			...
			<tr>
				<th>赔付率&nbsp;&nbsp;&nbsp;：</th>
				<td><%=contact.getLossratio()%></td>
			</tr>

			<tr>
				<th>协议温度：</th>
				<td><%=contact.getProtocoltemperature()%></td>
			</tr>
		...
		<div align="center">
			<button class="btn btn-primary" data-toggle="modal"
				data-target="#mymodal-data" type="submit">合同转让</button>
		</div>
	</div>
	<!-- 模态弹出窗内容 -->
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">确定转让</button>
