...
<body>
	...
	<form action="RegisterCompanyAction.action" method="post">
		<div class="register">
			...
			<div class="form-horizontal">
				<div class="form-group">
					<label for="verify_pwd" class="col-sm-4 control-label">银行账户</label>
					<div class="col-sm-5">
						<input type="password" class="form-control" id="bankaccount"
			...
			<div class="form-horizontal">
				<div class="form-group">
					...
					<div class="col-sm-5">
						<select name="profession" class="text-control" id="profession">
			...
			<div class="form-horizontal">
				<div class="form-group">
					...
					<div class="col-sm-5">
						<select name="property" class="text-control" id="property">
							<option value="1">tessdfcsdfsft1</option>
							<option value="2">test2</option>
							<option value="3">test3</option>
						</select>
			...
			<div align="center" class="checkbox">
				<label> <input type="checkbox"><a href="XXX">
						同意《XXX》协议</a>
				</label>
			</div>
