...
<div id="nav">
  <ul>
    ...
    <li ><a href="plat_describ.jsp">平台介绍<span>DESCRIPTION</span></a></li>
        <div class="n"></div>
    <li ><a href="index_info.jhtml">进行交易<span>TRANSACTION</span></a>
      <ul>
    ...
    <div class="n"></div>
    <li ><a href="bbs.jsp">交流论坛<span>COMMUNICATION BBS</span></a></li>
  </ul>
...
<% try{
  ...
  <div class="form-horizontal">
      <div class="form-group">
        ...
        <div class="col-sm-5">
        <input type="text" class="form-control" id="email" name="email"placeholder="" value="<%=user.getEmail() %>" readonly="true"></input>
        </div>
      </div>
    </div>
  ...
  <div class="form-horizontal">
      <div class="form-group">
        <label for="Email" class="col-sm-4 control-label">用户类型</label>
        <div class="col-sm-5">
        <input type="text" class="form-control" id="type" name="type"placeholder="" value="个人" readonly="true"></input>
        </div>
      </div>
    </div>
      <div class="form-horizontal">
    	...
    	<div class="col-sm-5">
    	<input type="text" class="form-control" name="name" id="name" placeholder="" value="<%=user.getName() %>" readonly="readonly"></input>
   		</div>
  		</div>
	  </div>
    <div class="form-horizontal">
      ...
      <div class="col-sm-5">
      <input type="text" class="form-control" id="ID" name="ID" placeholder="" value="<%=user.getId() %>" readonly="true"></input>
      </div>
      </div>
    </div>
             <div class="form-horizontal">
       <div class="form-group">
      <label for="inputPassword" class="col-sm-4 control-label">银行账户</label>
      <div class="col-sm-5">
      <input type="text" class="form-control" id="bankaccount" name="bankaccount" placeholder="" value="<%=user.getBankaccount() %>" readonly="readonly" ></input>
           ...
           <div class="form-horizontal">
  		<div class="form-group">
    	<label for="inputPassword" class="col-sm-4 control-label">信用等级</label>
    	<div class="col-sm-5">
         ...
         <div class="form-horizontal">
  		<div class="form-group">
    	<label for="inputPassword" class="col-sm-4 control-label">交易数量</label>
    	<div class="col-sm-5">
             <input type="text" class="form-control" id="dealamout" name="dealamout" placeholder="" value="<%=user.getDealamount() %>" readonly="readonly"></input>
   		</div>
  		</div>
	  </div>
      ...
      <div class="form-horizontal">
    	...
    	<div class="col-sm-5">
    	<select name="profession" class="text-control3">
      ...
      <div class="form-horizontal">
    	...
    	<div class="col-sm-5">
    	<select name="property" class="text-control3">
        	<option value="1">很有钱</option>
        	<option value="2">test2</option>
	        <option value="3">test3</option>
        </select>
   		</div>
      ...
      <div class="form-horizontal">
    	...
    	<div class="col-sm-5">
        <input type="text" class="text-control4"><%=user.getBrief() %></input>
   		</div>
  		</div>
	  </div>
      
      <br />
      <input type="hidden" name="command" value="RegistIndividual" />
      <input type="hidden" name="status" value="1"/>
    <div align="center" class="col-sm-4 col-sm-offset-4">  
  		 <input type="submit" class="btn btn-primary btn-block" style="margin:80px 0 0 0" value="提交"></input> <!--提交后到self_info_person.jsp-->
