...
<table class="table" style="width:500px;text-align:center;margin:20px 100px">
  <%
			try{
				...
				Derivative derivative = cc.getPlatformDerivativeInfo(derivativeID);
		%>
  <tr>
    <th class="col-sm-4">
      衍生品ID：
 ...
 <tr>
  ...
  <tr>
    <th>剩余数量：</th>
   <td>
   <%=derivative.getAmount() %>
   </td>
  </tr>
  <%}catch(Exception e)
  {}%>
  <form action="BuyDerivativeAction.action" method="post">
  <tr>
    <td style="text-align:center;" colspan="2">您需要购买<input type="text" name="hand" style="width:30px" />份</td>
    </tr>
  <tr>
    <td style="text-align:center" colspan="2"><input class="btn btn-primary" style="width:100px;height:35px" type="submit" value="确认购买"></td>
  </tr>
</table>
</form>
</div>
